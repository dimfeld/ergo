...
<form class="w-96 max-w-xl flex flex-col space-y-4" on:submit|preventDefault={handleSubmit}>
  <Labelled label="Local ID"><input class="w-full" type="text" bind:value={triggerId} /></Labelled>
  <Labelled label="Description"
    ><input class="w-full" type="text" bind:value={trigger.name} /></Labelled
  >
  <Labelled label="Input Type">
