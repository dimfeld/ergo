...
INSERT INTO object_ids (object_id, type) VALUES (1, 'global'::object_type);
...
CREATE TABLE user_entity_permissions (
  user_entity_id uuid not null references user_entity_ids (user_entity_id) ON DELETE CASCADE,
  permission_type permission not null,
  permissioned_object bigint not null references object_ids(object_id) ON DELETE CASCADE,
